...
public class RobotQQ {
    ...
    public boolean sendPrivateMessage(QQ QQ, String content) {
        ...
        runCommand(SEND_MSG, this.getQQNumber(), TYPE_FRIEND, 0, 0L, QQ.getNumber(), event.getMessage());
        return booleanResult();
    }
    ...
    public boolean sendGroupMessage(Group group, String content) {
        ...
        runCommand(SEND_MSG, this.getQQNumber(), TYPE_GROUP, 0, event.getGroup().getNumber(), 0L, event.getMessage());
        return booleanResult();
    }
    ...
    public boolean sendDiscussionMessage(Discussion discussion, String content) {
        ...
        runCommand(SEND_MSG, this.getQQNumber(), TYPE_DISCUSS, 0, 0L, event.getDiscussion().getNumber(), event.getMessage());
        return booleanResult();
    }
/*
