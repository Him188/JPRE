...
import net.coding.lamgc.coolq.jpre.event.*;
import net.coding.lamgc.coolq.jpre.exception.PluginEventException;
import net.coding.lamgc.coolq.jpre.exception.PluginLoadException;
import net.coding.lamgc.coolq.jpre.plugin.Plugin;
import net.coding.lamgc.coolq.jpre.plugin.PluginDescription;
 ...
 * <p>
 * 加载插件:
 * 注意! 运行环境启动时 (即酷Q启动时), 会自动搜索插件目录下所有 .jar 后缀的文件并尝试加载.
 * 一般来说, 不需要手动加载插件.
